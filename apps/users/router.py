...
from .views import UserViewSet, UserInfoViewset, GroupViewSet, UserGroupsViewset, GroupMembersViewset
...
users_router.register(r'group', GroupViewSet, base_name="group")
